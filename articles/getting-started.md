...
Download a single bundle containing the synthetic data, a data
dictionary, the synthesis spec, a manifest, a comparison report, and
diagnostic files — ready to share with collaborators or AI programming
tools.
